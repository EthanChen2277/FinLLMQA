...
# # set LLM path
MODEL_PATH = os.environ.get('GEMINI_DATA_IN1', 'THUDM/chatglm3-6b')
TOKENIZER_PATH = os.environ.get("GEMINI_DATA_IN1", MODEL_PATH)
# MODEL_PATH = TOKENIZER_PATH = snapshot_download(
#     "ZhipuAI/chatglm3-6b", revision="v1.0.0")

# set Embedding Model path
EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', 'BAAI/bge-large-zh-v1.5')
# EMBEDDING_PATH = r'D:\Repo\all-MiniLM-L6-v2'
...
async def predict(model_id: str, params: dict):
    ...
    chunk = ChatCompletionResponse(model=model_id, id="", choices=[
...
def predict_stream(model_id, gen_params):
    ...
    for new_response in generate_stream_chatglm3(model, tokenizer, gen_params):
        ...
        if not is_function_call and len(output) > 3:
